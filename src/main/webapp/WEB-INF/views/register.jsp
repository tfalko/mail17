...
<main role="main" class="container">
    <div class=>
        <div class="container pt-4 pb-4" style="margin-top: 100px">
...
<%--            <div><label> Item limit: <input type="number" name="limit"/> </label></div>--%>
            <div> <button class="btn btn-lg btn-primary btn-block" style="align-self: center" type="submit">Register</button></div>
